<?php
	...
	if(isset($_POST['SubmitButton'])) { //check if form was submitted
		$ESN = $_POST['ESN']; //get input text
		$message = "Success! Your ESN is : ".$ESN; 
		$numberOfFrame = $_POST['numFrames'];
		$message1 = "Success! The number of frames is : ".$numberOfFrame;
		$start = $_POST['start'];
		$message2 = "Success! Your start time is : ".$start;
		$end = $_POST['end'];
		$message3 = "Success! Your end time is :  ".$end;
		$timelapseType = $_POST['timeType'];
		$message4 = "Success! Your type of video is : ".$timelapseType;
		$frameType= $_POST['frameType'];
		$message5 = "Success! Your type of frame is : ".$frameType;

		$value1 = $timelapseType == "Evenly";
		$value2 = $frameType == "Preview";
		
		if($timelapseType == "Evenly" && $frameType == "Preview") {
	...
	} /* else statement gives error for some reason?
	else {
